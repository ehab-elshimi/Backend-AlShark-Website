...
<aside id="side-overlay">
    ...
    <div class="content-header border-bottom">
        ...
        <a class="img-link mr-1" href="javascript:void(0)">
            <img class="img-avatar img-avatar32" src="dashboard/media/avatars/avatar10.jpg" alt="">
        </a>
        <!-- END User Avatar -->
                        ...
                        <div class="block-content">
                            ...
                            <ul class="nav-items mb-0">
                                <li>
                                    <a class="media py-2" href="javascript:void(0)">
                                        <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                            <img class="img-avatar img-avatar48" src="dashboard/media/avatars/avatar7.jpg" alt="">
                                ...
                                <li>
                                    <a class="media py-2" href="javascript:void(0)">
                                        <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                            <img class="img-avatar img-avatar48" src="dashboard/media/avatars/avatar12.jpg" alt="">
                                            <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-success"></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <li>
                                    <a class="media py-2" href="javascript:void(0)">
                                        <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                            <img class="img-avatar img-avatar48" src="dashboard/media/avatars/avatar6.jpg" alt="">
                                            <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-success"></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <li>
                                    <a class="media py-2" href="javascript:void(0)">
                                        <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                            <img class="img-avatar img-avatar48" src="dashboard/media/avatars/avatar5.jpg" alt="">
                                ...
                                <li>
                                    <a class="media py-2" href="javascript:void(0)">
                                        <div class="mr-3 ml-2 overlay-container overlay-bottom">
                                            <img class="img-avatar img-avatar48" src="dashboard/media/avatars/avatar14.jpg" alt="">
                                            <span class="overlay-item item item-tiny item-circle border border-2x border-white bg-warning"></span>
                                        </div>
                                        <div class="media-body">
...
<nav id="sidebar" aria-label="Main Navigation">
    ...
    <div class="content-header bg-white-5">
        ...
        {{-- <div> --}}
            ...
            <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
            {{-- <a class="d-lg-none btn btn-sm btn-dual ml-1 text-light" data-toggle="layout" data-action="sidebar_close" href="javascript:void(0)">
                <i class="fa fa-fw fa-times"></i>
            </a> --}}
            <!-- END Close Sidebar -->
        {{-- </div> --}}
